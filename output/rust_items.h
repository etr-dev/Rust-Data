...
// ItemIds updated by: https://github.com/erobin27/Rust-Data
// Monday, 9/16/2024 - 3:07:21PM EST

namespace RustItems {
	inline std::map<std::string, std::string> IdToName{
	...
	inline std::map<std::string, int> NameToId{
		{"hat.wolf", -1478212975},
